                                 ...
                                 const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	// NET_LOG(LogTemp,Warning,TEXT("준비 동작 실행"));
...
{
	// NET_LOG(LogTemp,Warning,TEXT("준비 동작 종료"));
...
{
	// NET_LOG(LogTemp,Log,TEXT("Task에 의한 좌클릭 후속 입력"));
...
{
	// NET_LOG(LogTemp,Log,TEXT("Task에 의한 우클릭 후속 입력"));
...
{
	// NET_LOG(LogTemp,Warning,TEXT("스킬 동작 실행"));
...
{
	// NET_LOG(LogTemp,Warning,TEXT("스킬 동작 종료"));
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, true);
}
